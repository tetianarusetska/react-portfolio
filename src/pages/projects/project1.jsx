...
export default function Project1() {
    return <div className="project1 flex flex-col justify-center items-center gap-[40px]">
        <p className="text-center leading-[1.2em] font-[Montserrat, sans-serif] text-[32px] font-extralight mt-[80px]">"Yehor Lemzyakoff" (Figma) UI, UX</p>
